...
quietly set PROJECT_DIR "C:/Users/Victor Ros/Documents/Cookies/wake_up_radio/auxpoyect/WupPMODbyIRQnoMultiRX"
...
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/hdl/manchesterDecoder_0toStart.vhd"
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/hdl/Mom_unit_indirectACK.vhd"
...
vcom -93 -explicit  -work presynth "${PROJECT_DIR}/component/Actel/Simulation/PULSE_GEN/1.0.1/PULSE_GEN.vhd"

vsim -L igloo -L presynth  -t 1ps presynth.TB_WUPU_Complete
add wave /TB_WUPU_Complete/WuPu_0/*
run 10 ps
