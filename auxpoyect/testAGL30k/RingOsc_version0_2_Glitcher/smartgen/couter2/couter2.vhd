...
architecture DEF_ARCH of couter2 is 
  ...
  component AND3
    ...
    signal NU_0, NU_1, NU_2, NU_3, NU_0_1, NU_1_2, NU_0_1_2, 
        INV_1_Y, INV_2_Y, INV_0_Y, XOR2_0_Y, AND2_0_Y
         : std_logic;
...
begin 
    ...
    U_AND2_Tcnt : AND2
      port map(A => NU_0_1_2, B => NU_3, Y => Tcnt);
...
-- MGNTIMER:F
-- MGNCMPL:T
-- DESDIR:C:/Users/Victor Ros/Documents/Cookies/wake_up_radio/auxpoyect/testAGL30k/RingOsc_version0_2_Glitcher/smartgen\couter2
-- GEN_BEHV_MODULE:F
