--#####################################################################
-- component LowPowerMana_wrapper
-- port ( 
...
entity LowPowerMana_wrapper is  
port ( 
     Flash_Freeze_N:in std_logic;
     RST_N:in std_logic;
     CLK:in std_logic;
...
end LowPowerMana_wrapper;

architecture DEF_ARCH of LowPowerMana_wrapper is
